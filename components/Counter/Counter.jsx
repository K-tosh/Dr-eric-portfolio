    ...
    >
      <div className="container px-3 px-lg-4">
        ...
        <div className="row justify-content-center mt-5">
          <div className="col-12 col-lg-8 text-center">
            <div className="cta-section p-4 bg-white rounded-lg shadow">
              <div className="row align-items-center">
                <div className="col-12 col-md-8">
                  <h4 className="mb-2 font-weight-bold text-dark">
                    <i className="icofont icofont-ui-user mr-2 text-primary"></i>
                    Ready to Join Our Satisfied Patients?
                  </h4>
                  <p className="mb-0 text-muted">
                    Experience the quality healthcare that thousands of patients trust. 
                    Book your consultation today and become part of our success story.
                  </p>
                </div>
                <div className="col-12 col-md-4 mt-3 mt-md-0">
                  <a 
                    href="https://wa.me/25491674164?text=Hi%20Dr.%20Eric,%20I%20would%20like%20to%20book%20a%20consultation." 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="btn btn-primary btn-lg rounded-pill font-weight-bold"
              ...
              <div className="row">
                <div className="col-6 col-md-3 mb-3">
                  <div className="trust-item">
                    <i className="icofont icofont-certificate text-warning mb-2" style={{fontSize: '2rem'}}></i>
                    <h6 className="mb-0 font-weight-bold text-white">Licensed</h6>
                    <small className="text-light">KMPDC Certified</small>
                  </div>
                </div>
                
                <div className="col-6 col-md-3 mb-3">
                  <div className="trust-item">
                    <i className="icofont icofont-shield-alt text-success mb-2" style={{fontSize: '2rem'}}></i>
                    <h6 className="mb-0 font-weight-bold text-white">Insured</h6>
                    <small className="text-light">Professional Coverage</small>
                  </div>
                </div>
                
                <div className="col-6 col-md-3 mb-3">
                  <div className="trust-item">
                    <i className="icofont icofont-clock-time text-info mb-2" style={{fontSize: '2rem'}}></i>
                    <h6 className="mb-0 font-weight-bold text-white">24/7 Support</h6>
                    <small className="text-light">Always Available</small>
                  </div>
                </div>
                
                <div className="col-6 col-md-3 mb-3">
                  <div className="trust-item">
                    <i className="icofont icofont-heart-beat text-danger mb-2" style={{fontSize: '2rem'}}></i>
                    <h6 className="mb-0 font-weight-bold text-white">Trusted</h6>
                    <small className="text-light">Patient Focused</small>
                  </div>
                </div>
              </div>
            </div>
